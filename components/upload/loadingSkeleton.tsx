...
export default function LoadingSkeleton() {
  return (
    <Card className="relative px-2 h-[500px] sm:h-[600px] lg:h-[700px] w-full xl:w-[600px] max-w-lg mx-auto overflow-hidden bg-linear-to-br from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
      ...
      {/* Loading Content */}
      <div className="h-full overflow-y-auto scrollbar-hide pb-24 md:pt-16">
        <div className="px-6">
          {/* Loading Title */}
