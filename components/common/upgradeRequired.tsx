      ...
      <div className="container px-8 py-16">
        <div className="flex flex-col items-center justify-center gap-8 text-center max-w-2xl mx-auto">
          <div className="flex items-center gap-2 text-rose-500">
            ...
            <span className="text-sm font-medium uppercase tracking-wider">
              Premium Feature
                  ...
                  <h1 className='text-4xl font-bold tracking-tighter bg-linear-to-r from-gray-900 to-gray-600 
          bg-clip-text text-transparent'>Subscription Required</h1>
                  <p className='text-lg leading-8 text-gray-600 border-2 border-rose-200 
          bg-white/50 backdrop-blur-xs rounded-lg p-6 border-dashed max-w-xl'>
            ...
            <span className="text-rose-500">this feature 💖</span>
          </p>
